...
<body>
	...
	<div class="container" style="margin: 10px;">
		...
		<form class="form-horizontal" action="../UpdateUser" method="post"
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="text" class="form-control" name="FirstName"
						id="FirstName" value="<%=user.getFirstName()%>"
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="text" class="form-control" name="LastName"
						id="LastName" value="<%=user.getLastName()%>"
						placeholder="Enter Last Name" maxlength="30">
				</div>
			</div>
			...
			<!-- form: User Image -->
			<div class="form-group">
				<label class="control-label col-sm-2" for="UserImage"
					class="col-sm-2">User Image</label>
				<div class="col-md-5">
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="text" class="form-control" name="Phone" id="Phone"
						value="<%=user.getPhone()%>" placeholder="Enter Phone"
