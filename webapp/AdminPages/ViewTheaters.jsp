...
<body>
	...
	<h2 align=center>
		<font color=black> Theaters list :- ${param.msg}</font>
	</h2>
		...
		<table class="table table-striped" align="center" border=1 width=90%>
			...
			<tbody>
				...
				<tr>
					...
					<td align=center><%=theater.getName()%></td>

					<td align=center><%=theater.getStreet() + " " + theater.getHouseNumber() + ", " + theater.getCity()%>
					</td>


					<td align=center><a
						href="ViewHalls.jsp?TheaterId=<%=theater.getTheaterId()%>"> <i
							class='fa fa-th' aria-hidden='true'></i>
					</a></td>

					<td align=center><a
						href="UpdateTheater.jsp?TheaterId=<%=theater.getTheaterId()%>">
							<i class='fa fa-pencil-square-o fa-lg' aria-hidden='true'></i>
					</a></td>

					<td align=center><a
						href="../Delete?Item=Theater&TheaterId=<%=theater.getTheaterId()%>">
