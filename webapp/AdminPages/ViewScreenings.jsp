...
<body>
	...
	<h2 align=center>
		<font color=black>Screenings list :- ${param.msg}</font>
	</h2>
	...
	<div class="form-group">
		<label class="control-label col-sm-2" for="TheaterId"></label>
		<div class="col-md-5">

			<form action="ViewScreenings.jsp">
				<div class="form-inline" align="center">
					<select name="TheaterId" id="TheaterId" class="form-control">
						...
						%>
					</select> <input type="submit" class="btn btn-primary" value="Submit">
				</div>
			</form>
	...
	<div class="table-responsive shadow p-3 mb-5 bg-white rounded">
		<table class="table table-striped" align="center" border=1 width=90%>
			...
			<tbody>
				<%
				ArrayList<ScreeningToDisplay> shows = ScreeningDao.getScreeningDisplayByTheaterId(theaterId);
				int i = 0;
				for (ScreeningToDisplay screening : shows) {
					i++;
				%>
				<tr>
					<td align=center><%=i%></td>
					<td align=center><%=screening.getHallNum()%></td>
					<td align=center><%=screening.getMovieName()%></td>
					<td align=center><%=screening.getDate()%></td>
					<td align=center><%=screening.getTime()%></td>
					<td align=center><%=screening.getOpenForSale()%></td>


					<td align=center><a
						href="UpdateScreening.jsp?ScreeningId=<%=screening.getScreeningId()%>">
							<i class='fa fa-pencil-square-o fa-lg' aria-hidden='true'></i>
					</a></td>

					<td align=center><a
						href="../Delete?Item=Screening&ScreeningId=<%=screening.getScreeningId()%>&TheaterId=<%=theaterId%>">
